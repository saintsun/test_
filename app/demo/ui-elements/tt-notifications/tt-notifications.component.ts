...
import { MessageService } from '.pages/@pages/components/message/message.service';

@Component({
  selector: 'app-tt-notifications',
  templateUrl: './tt-notifications.component.html',
  styleUrls: ['./tt-notifications.component.css'],
  encapsulation: ViewEncapsulation.None,
})


export class TtNotificationsComponent implements OnInit {
  ...
  ngAfterViewChecked() {
    ...
    let el = window.document.querySelector('.nav.nav-tabs');
